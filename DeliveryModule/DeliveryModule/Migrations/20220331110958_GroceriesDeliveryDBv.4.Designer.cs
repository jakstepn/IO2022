...
namespace DeliveryModule.Migrations
{
    ...
    [Migration("20220331110958_GroceriesDeliveryDBv.4")]
    partial class GroceriesDeliveryDBv4
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DeliveryModule.Database_Models.Client", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DeliveryModule.Database_Models.Courier", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DeliveryModule.Database_Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DeliveryModule.Database_Models.Courier", b =>
                {
                    b.HasOne("DeliveryModule.Database_Models.Order", "CurrentOrder")
                        .WithMany()
                        .HasForeignKey("CurrentOrderId");

                    b.HasOne("DeliveryModule.Database_Models.CourierStatusClass", "CurrentState")
                        .WithMany()
            ...
            modelBuilder.Entity("DeliveryModule.Database_Models.Order", b =>
                {
                    b.HasOne("DeliveryModule.Database_Models.Client", "Client")
                        .WithMany()
